...
import { stockReport } from '../../Service/api';
// import SrModal from "../OurModal/SrModal"
...
const SrTable = (props) => {
  ...
  const getSalesQuotationDatas = async () => {
    let response = await stockReport();
    if (response) {
    ...
    <div className="container">
      <div className="row">
        ...
        {/* <div className="col-md-4 col-sm-4">
          <SrModal onClick={() => getSelectedRows(SelectedList)} clickedData={SelectedList} main={SelectedList.length}>
