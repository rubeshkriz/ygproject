  ...
  let handleChange = (e) => {
    ...
    if (name === "ItemCode") {
      ...
      setFormValues({
        ...
        ItemDescription: result[0].ItemName,
        Size: result[0].FrgnName,
      });
                  ...
                  <div className="col-md-2">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        name="DiscountPrice"
                        className="form-control"
                        values={FormValues.DiscountPrice}
                        onChange={handleChange}
                  ...
                  <div className="col-md-3">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        name="AdrDiscount"
                        className="form-control"
                        values={FormValues.AdrDiscount}
                        onChange={handleChange}
                        placeholder="ADR Discount"
                      />
